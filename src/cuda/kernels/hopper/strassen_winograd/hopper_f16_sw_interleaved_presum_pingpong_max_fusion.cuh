...
public:
  using StrassenGemmKernel = HopperF16InterleavedPresumPingpongMaxFusion_2x128_2x128_OptNoKernel;
...
class HopperF16InterleavedPresumPingpongMaxFusion_2x128_2x128_Opt_0000 {
public:
  using StrassenGemmKernel = HopperF16InterleavedPresumPingpongMaxFusion_2x128_2x128_Opt_0000Kernel;
  using GemmKernel = typename StrassenGemmKernel::GemmKernel;
  using Arguments = typename StrassenGemmKernel::Arguments;
  using RasterOrderOptions = typename cutlass::gemm::kernel::detail::PersistentTileSchedulerSm90Params::RasterOrderOptions;
...
public:
  using StrassenGemmKernel = HopperF16InterleavedPresumPingpongMaxFusion_4x128_4x128_OptNoKernel;
  using GemmKernel = typename StrassenGemmKernel::GemmKernel;
  using Arguments = typename StrassenGemmKernel::Arguments;
  using RasterOrderOptions = typename cutlass::gemm::kernel::detail::PersistentTileSchedulerSm90Params::RasterOrderOptions;
...
public:
  using StrassenGemmKernel = HopperF16InterleavedPresumPingpongMaxFusion_8x128_8x128_OptNoKernel;
  using GemmKernel = typename StrassenGemmKernel::GemmKernel;
  using Arguments = typename StrassenGemmKernel::Arguments;
  using RasterOrderOptions = typename cutlass::gemm::kernel::detail::PersistentTileSchedulerSm90Params::RasterOrderOptions;
