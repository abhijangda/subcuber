...
using HopperF64SWInterleavedPresumLevel1_128x64Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
                                                        double,
                                                        RowMajor,
                                                        double,
                                                        RowMajor,
...
class HopperF64SWInterleavedPresumLevel1_128x64 {
public:
  using StrassenGemmKernel = HopperF64SWInterleavedPresumLevel1_128x64Kernel;
