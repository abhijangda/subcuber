...
using BlackwellF64SWInterleavedPresumLevel1_32x64Kernel = cutlass::gemm::device::StrassenGemm<
  StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
  double, RowMajor,
  double, RowMajor,
  double, RowMajor,
  double,
...
class BlackwellF64SWInterleavedPresumLevel1_32x64 {
public:
  using StrassenGemmKernel = BlackwellF64SWInterleavedPresumLevel1_32x64Kernel;
