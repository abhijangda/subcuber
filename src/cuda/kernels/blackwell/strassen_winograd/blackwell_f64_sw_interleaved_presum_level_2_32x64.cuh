...
using BlackwellF64SWInterleavedPresumLevel2_32x64Kernel = cutlass::gemm::device::StrassenGemmLevel2<
  StrassenKind,
...
class BlackwellF64SWInterleavedPresumLevel2_32x64 {
public:
  using StrassenGemmKernel = BlackwellF64SWInterleavedPresumLevel2_32x64Kernel;
