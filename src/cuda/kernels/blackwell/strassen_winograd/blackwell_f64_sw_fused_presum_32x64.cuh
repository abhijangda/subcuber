...
using BlackwellF64SWFusedPresumLevel1_32x64Kernel = cutlass::gemm::device::StrassenGemm<
...
class BlackwellF64SWFusedPresumLevel1_32x64 {
public:
  using StrassenGemmKernel = BlackwellF64SWFusedPresumLevel1_32x64Kernel;
