...
using AllPresumsKernel = AllPresums<PresumGlobalKernel,   PresumGlobalKernel,  PresumGlobalKernel,   PresumGlobalKernel,  //A Presums
                                    PresumGlobalKernel,   PresumGlobalKernel,  PresumGlobalKernel,   PresumGlobalKernel>; //B Presums
using AllPresumsM0    = AllPresums<>;
...
using AmpereF16SWKernelPresumKernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
                                                ElementInputA,
                                                LayoutInputA,
                                                ElementInputB,
                                                LayoutInputB,
...
class AmpereF16SWKernelPresum {
public:
  using StrassenGemmKernel = AmpereF16SWKernelPresumKernel;
