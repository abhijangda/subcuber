...
using AmpereF16SWInterleavedPresumLowFusionKernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
                                                ElementInputA,
                                                LayoutInputA,
                                                ElementInputB,
                                                LayoutInputB,
...
class AmpereF16SWInterleavedPresumLowFusion {
public:
  using StrassenGemmKernel = AmpereF16SWInterleavedPresumLowFusionKernel;
