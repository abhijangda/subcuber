...
using AmpereF16SWInterleavedPresumMaxFusionKernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
                                                ElementInputA,
                                                LayoutInputA,
                                                ElementInputB,
                                                LayoutInputB,
...
class AmpereF16SWInterleavedPresumMaxFusion {
public:
  using StrassenGemmKernel = AmpereF16SWInterleavedPresumMaxFusionKernel;
