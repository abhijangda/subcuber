...
DECLARE_KERNEL_RUN_FN(run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_4x256_4x256_opt_no);
DECLARE_KERNEL_RUN_FN(run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_8x256_8x256_opt_no);
...
DECLARE_KERNEL_RUN_FN(run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_tma_reduce_4x256_4x256_opt_no);
DECLARE_KERNEL_RUN_FN(run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_tma_reduce_8x256_8x256_opt_no);
...
static const KernelEntry kKernels[] = {
  ...
  {"ampere_f64_cutlass_128x128", "ampere", "f64", 0, run_ampere_f64_cutlass_128x128},
    ...
    {"hopper_f16_sw_interleaved_presum_cooperative_max_fusion_4x256_4x256_opt_no", "hopper", "f16", 1, run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_4x256_4x256_opt_no},
    {"hopper_f16_sw_interleaved_presum_cooperative_max_fusion_8x256_8x256_opt_no", "hopper", "f16", 1, run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_8x256_8x256_opt_no},
    ...
    {"hopper_f16_sw_interleaved_presum_cooperative_max_fusion_tma_reduce_4x256_4x256_opt_no", "hopper", "f16", 1, run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_tma_reduce_4x256_4x256_opt_no},
    {"hopper_f16_sw_interleaved_presum_cooperative_max_fusion_tma_reduce_8x256_8x256_opt_no", "hopper", "f16", 1, run_hopper_f16_sw_interleaved_presum_cooperative_max_fusion_tma_reduce_8x256_8x256_opt_no},
